...
for i in range(sheet.ncols):
    datasetX[27+i] = sheet.col_values(i)[8:16]
    datasetY[27+i] = sheet.col_values(i)[24:30]
for i in range(sheet.ncols):
    datasetX[54+i] = sheet.col_values(i)[16:24]
    datasetY[54+i] = sheet.col_values(i)[24:30]
